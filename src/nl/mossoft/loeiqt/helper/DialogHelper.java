...
public class DialogHelper {
    ...
    private static String convertToURL(XComponentContext xContext, File dialogFile) {
	String sURL = null;
	try {
    ...
    private static void showMessageBox(XComponentContext context, XDialog dialog, MessageBoxType type, String sTitle,
	    String sMessage) {
	XToolkit xToolkit;
	try {
