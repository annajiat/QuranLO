...
public class DialogHelper {
   ...
   */
  public static String convertToUrl(final XComponentContext context, final File dialogFile) {
    String url = null;
    try {
   ...
   */
  public static XDialog createDialog(final String xdlFile, final XComponentContext context,
      final XDialogEventHandler handler) {
    ...
    try {
      ...
      final XDialogProvider2 dialogProv =
          UnoRuntime.queryInterface(XDialogProvider2.class, dialogProvider);
      final File dialogFile = FileHelper.getDialogFilePath(xdlFile, context);
   ...
   */
  public static void enableButton(final XDialog dialog, final String componentId,
      final boolean enabled) {
    final XControlContainer dlgContainer =
        UnoRuntime.queryInterface(XControlContainer.class, dialog);
    // retrieve the control that we want to disable or enable
    final XControl control =
   ...
   */
  public static void enableComponent(final XDialog dialog, final String componentId,
      final boolean enabled) {
    final XControlContainer dlgContainer =
        UnoRuntime.queryInterface(XControlContainer.class, dialog);
   ...
   * @return a button
   */
  public static XButton getButton(final XDialog dialog, final String componentId) {
    final XControlContainer dlgContainer =
        UnoRuntime.queryInterface(XControlContainer.class, dialog);
    final Object control = dlgContainer.getControl(componentId);
   ...
   * @return the CheckBox
   */
  public static XCheckBox getCheckBox(final XDialog dialog, final String componentId) {
    final XControlContainer dlgContainer =
        UnoRuntime.queryInterface(XControlContainer.class, dialog);
    final Object control = dlgContainer.getControl(componentId);
   ...
   * @return a combobox
   */
  public static XComboBox getCombobox(final XDialog dialog, final String componentId) {
    final XControlContainer dlgContainer =
        UnoRuntime.queryInterface(XControlContainer.class, dialog);
    final Object control = dlgContainer.getControl(componentId);
   ...
   * @return a edit field
   */
  public static XTextComponent getEditField(final XDialog dialog, final String componentId) {
    final XControlContainer dlgContainer =
        UnoRuntime.queryInterface(XControlContainer.class, dialog);
    final Object control = dlgContainer.getControl(componentId);
  ...
  public static XFixedText getLabel(final XDialog dialog, final String componentId) {
    final XControlContainer dlgContainer =
        UnoRuntime.queryInterface(XControlContainer.class, dialog);
    final Object control = dlgContainer.getControl(componentId);
   ...
   * @return a list box
   */
  public static XListBox getListBox(final XDialog dialog, final String componentId) {
    final XControlContainer dlgContainer =
        UnoRuntime.queryInterface(XControlContainer.class, dialog);
    final Object control = dlgContainer.getControl(componentId);
   ...
   */
  public static XNumericField getNumericField(final XDialog dialog, final String componentId) {
    final XControlContainer dlgContainer =
        UnoRuntime.queryInterface(XControlContainer.class, dialog);
    final Object control = dlgContainer.getControl(componentId);
   ...
   * @return the position
   */
  public static Point getPosition(final XDialog dialog) {
    int posX = 0;
    int posY = 0;
    final XControlModel dialogModel = UnoRuntime.queryInterface(XControl.class, dialog).getModel();
    final XPropertySet propSet = UnoRuntime.queryInterface(XPropertySet.class, dialogModel);
    try {
   ...
   */
  public static XProgressBar getProgressBar(final XDialog dialog, final String componentId) {
    final XControlContainer dlgContainer =
        UnoRuntime.queryInterface(XControlContainer.class, dialog);
    final Object control = dlgContainer.getControl(componentId);
   ...
   */
  public static void setFocus(final XTextComponent editField) {
    final XWindow controlWindow = UnoRuntime.queryInterface(XWindow.class, editField);
   ...
   */
  public static void setPosition(final XDialog dialog, final int posX, final int posY) {
    final XControlModel dialogModel = UnoRuntime.queryInterface(XControl.class, dialog).getModel();
    final XPropertySet propSet = UnoRuntime.queryInterface(XPropertySet.class, dialogModel);
    try {
   ...
   */
  public static void showErrorMessage(final XComponentContext context, final XDialog dialog,
   ...
   * @param message the message
   */
  public static void showInfoMessage(final XComponentContext context, final XDialog dialog,
      final String message) {
   ...
   * @param message the message
   */
  public static void showMessageBox(final XComponentContext context, final XDialog dialog,
      final MessageBoxType type, final String title, final String message) {
    XToolkit toolkit;
    try {
    ...
    final XMessageBoxFactory messageBoxFactory =
        UnoRuntime.queryInterface(XMessageBoxFactory.class, toolkit);
    final XWindowPeer parentWindowPeer = UnoRuntime.queryInterface(XWindowPeer.class, dialog);
    final XMessageBox messageBox = messageBoxFactory.createMessageBox(parentWindowPeer, type,
   ...
   * @param message the message
   */
  public static void showWarningMessage(final XComponentContext context, final XDialog dialog,
      final String message) {
